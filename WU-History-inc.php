...
$WunderWrong = true;
//
$timezone   = "Europe/Berlin";                      // Change to your TZ.  Ken True has a list available at http://saratoga-weather.org/timezone.txt  
$WUID       = "IRSSEL38";                           // Your stations Wunderground ID
$units      = "M";                                  // Default units which are changeable at runtime.  "M" for Metric, "E" for English or "B" for Both
$birthday   = "01-11-2023";                         // Stations first day of operation format dd-mm-yyyy.  This will determine years on the date selector.
$birthday   = "31-12-2024";                         // all that's left in wu API data
...
$Langtitle  = "RueKoe-Weather Station Historical Data";            // The Bold text at the top
...
$LangFtext  = "Hessen County Weather";              // Anything you wish or "" for a plain bar
